#ifndef __gA30Cxh29L0kjVl2jnHlRB_h__
#define __gA30Cxh29L0kjVl2jnHlRB_h__
...
#ifndef typedef_comm_internal_RandomIntegerGenerator_2
#define typedef_comm_internal_RandomIntegerGenerator_2

typedef struct tag_IXZbk4aPjQFR6fO0q1hmvH comm_internal_RandomIntegerGenerator_2;

#endif                                 /* typedef_comm_internal_RandomIntegerGenerator_2 */

#ifndef struct_tag_VPmGStR4dV8lz7dv5Pt8mB
#define struct_tag_VPmGStR4dV8lz7dv5Pt8mB

struct tag_VPmGStR4dV8lz7dv5Pt8mB
{
  int32_T isInitialized;
  boolean_T TunablePropsChanged;
};

#endif                                 /* struct_tag_VPmGStR4dV8lz7dv5Pt8mB */

#ifndef typedef_comm_internal_RandomIntegerGenerator
#define typedef_comm_internal_RandomIntegerGenerator

typedef struct tag_VPmGStR4dV8lz7dv5Pt8mB comm_internal_RandomIntegerGenerator;

#endif                                 /* typedef_comm_internal_RandomIntegerGenerator */
...
#ifndef struct_tag_uy8R3Z9jzlE9SoAKdBGMaC
#define struct_tag_uy8R3Z9jzlE9SoAKdBGMaC

struct tag_uy8R3Z9jzlE9SoAKdBGMaC
{
  char_T f1[3];
  char_T f2[4];
  char_T f3[8];
...
#endif                                 /* struct_tag_uy8R3Z9jzlE9SoAKdBGMaC */

#ifndef typedef_cell
#define typedef_cell

typedef struct tag_uy8R3Z9jzlE9SoAKdBGMaC cell;
...
#ifndef struct_tag_YgL81qPSE50MqdkMJZkJtD
#define struct_tag_YgL81qPSE50MqdkMJZkJtD

struct tag_YgL81qPSE50MqdkMJZkJtD
{
  cell _data;
};

#endif                                 /* struct_tag_YgL81qPSE50MqdkMJZkJtD */

#ifndef typedef_s_YgL81qPSE50MqdkMJZkJtD
#define typedef_s_YgL81qPSE50MqdkMJZkJtD

typedef struct tag_YgL81qPSE50MqdkMJZkJtD s_YgL81qPSE50MqdkMJZkJtD;

#endif                                 /* typedef_s_YgL81qPSE50MqdkMJZkJtD */
...
#ifndef typedef_InstanceStruct_gA30Cxh29L0kjVl2jnHlRB
#define typedef_InstanceStruct_gA30Cxh29L0kjVl2jnHlRB

typedef struct {
  SimStruct *S;
  comm_internal_RandomIntegerGenerator sysobj;
...
#endif                                 /* typedef_InstanceStruct_gA30Cxh29L0kjVl2jnHlRB */
...
extern void method_dispatcher_gA30Cxh29L0kjVl2jnHlRB(SimStruct *S, int_T method,
  void* data);
